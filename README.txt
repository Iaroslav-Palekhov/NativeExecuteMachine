Руководство по NEM (Native Execute Machine)
...
Быстрый старт
    ...
    Windows: Запусти NEM.exe 
    Linux:   Запусти NEM.x86_64 в терминале командой " ./NEM.x86_64 "

    SC-130022> - готово
    (числа после TNP это айди запущенного процесса и количество ядер процессора в конце)
...
В папке с исполняемым файлом NEM есть два файла
...
Что делать если
- Ошибка компиляции - смотри на указанную строку
- Программа не запускается - проверь расширение .bin
- Неправильный вывод - проверь кавычки в строках
